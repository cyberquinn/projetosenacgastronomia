...
<html lang="pt-br" >
    <head>
        <meta charset="UTF-8">
        <title>CodePen - Roman Milkovic&#39;s Flexbox Grid (Normalized)</title>
            ...
            <main class="content">
                <div class="feed-grid">
                    <div class="card-half wide">
                        <div class="card-img"><span class="label"> <i class="fa fa-star"></i></span><img src="assets/img/senac.png" alt="img"/></div>
                        <div class="card-text">
                            <h4>@thiagovieiramma </h4>
                            <p> olha a FACA! rs FBG do SENAC
                                aproveitei o tempo da minha reabilitação para poder estudar e aprender outras coisas. Então, aí estou!
                                #senacgastronomia </p>
                        </div>
                        <ul class="card-tools">
